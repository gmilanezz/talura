...
cargos_df["FUNCIONARIO"] = cargos_df["FUNCIONARIO"].astype(str).str.lstrip("0")

cargos_df["FIM"] = cargos_df["FUNCIONARIO"].map(demissao_map).fillna(0)
...
hierarquias_df["FUNCIONARIO"] = hierarquias_df["FUNCIONARIO"].astype(str).str.lstrip("0")

hierarquias_df["FIM"] = hierarquias_df["FUNCIONARIO"].map(demissao_map).fillna(0)
...
salarios_df["FUNCIONARIO"] = salarios_df["FUNCIONARIO"].astype(str).str.lstrip("0")

salarios_df["FIM"] = salarios_df["FUNCIONARIO"].map(demissao_map).fillna(0)
